 ...
 *         &lt;element name="FaxStatusList" type="{urn:FaxWS}RealTimeFaxStatusEx3List"/>
...
@XmlRootElement(name = "RealTimeFaxStatusEx3Response")
public class RealTimeFaxStatusEx3Response {

    @XmlElement(name = "return")
    protected boolean _return;
    @XmlElement(name = "FaxStatusList", required = true)
    protected RealTimeFaxStatusEx3List faxStatusList;
     ...
     * @return
     *     possible object is
     *     {@link RealTimeFaxStatusEx3List }
     *     
     */
    public RealTimeFaxStatusEx3List getFaxStatusList() {
     ...
     *     
     */
    public void setFaxStatusList(RealTimeFaxStatusEx3List value) {
